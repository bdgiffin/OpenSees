// ======================================================================== //
// C API functions for interacting with the ParticleDynamics library        //
// ======================================================================== //
...
extern "C" {
  ...
  void define_wind_field(const char* type, double* parameters) {
    particle_dynamics.wind_model = new_WindField(type,parameters);
  } // define_wind_field()
  ...
  void define_members(size_t n_members, size_t n_nodes_per_member, int *connectivity,
    ...
    particle_dynamics.members.define_members(n_members,n_nodes_per_member,connectivity,n_joints,x,y,z);
  } // define_members()
